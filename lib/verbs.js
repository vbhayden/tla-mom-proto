...
module.exports = {
    ...
    /**
     * Indicates the actor removed specific goal or task.  These statements will remove the specifed object from the actor's
     * Learner Profile.
     */
    "deselected": {
        "id": "https://w3id.org/xapi/tla/verbs/deselected",
        "display": {
            "en-US": "Indicates the actor removed specific goal or task."
        }
    },
}